export const weddingPageData = {
  ...
  venueData: {
    ...
    images: [
      "/wedding/venue-1.webp",
      "/wedding/venue-2.webp"
    ],
    link: {
      label: "CONTACT US",
      href: "#"
    ...
    items: [
      {
        ...
        answer: "We host all wedding-related celebrations including engagements, Mehendi, Sagan, Haldi, weddings, receptions, and post-wedding brunches."
      },
      {
  ...
  ctaData: {
    title: "Reserve your luxury holiday!",
    link: {
      label: "BOOK NOW",
      href: "#"
    }
